...
<?php
	...
	while($row = $webtoonView->fetchArray(SQLITE3_ASSOC)){         
		...
		echo "<td style='word-wrap:break-word;height:50px;' valign=middle><a style='margin:0px;padding:0px;width:100%;' href='list.php?title=".urlencode($toontitle)."&wr_id=".$toonid."'><span style='margin:0px;padding:0px;width:100%;line-height:16px;height:32px;font-size:14px;overflow: hidden;text-overflow: ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient: vertical;width:100%;'>".$epititle;
		echo "</span><span style='font-size:12px;width:100%;margin:0px;padding:0px;line-height:12px;width:100%;'>(".$uptdtime.")</span></a></td> ";
