...
<?php
		...
		foreach($get_html_contents->find('div.item') as $e){
			...
			if ( $is_adult || $adult != "(19)" ) {
				...
				echo "<td style='word-wrap:break-word;max-height:80px;' valign=middle><a href=list.php?title=".urlencode($subject)."&wr_id=".$wr_id.">".$subject."<br><font size='3'>[총편수:".$tooncnt."]</font><br>".$alreadyView."</a>\n";
				echo "</tr>\n";
				$loopcnt++;
			}
		}
