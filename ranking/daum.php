...
<?php
	...
	foreach ($data_array['data'] as $key => $value){
		echo "<li style='box-sizing: border-box;position: relative;float: left; height:170px;width:33%;'><img src='".$value['pcRecommendImage']['url']."' style='width:100%;max-height:95px;'>";
