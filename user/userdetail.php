...
<?php
	if ( $USER_LEVEL == 99999 ) {
		...
		while($row = $webtoonView->fetchArray(SQLITE3_ASSOC)){
			...
			echo "<tr style='background-color:#f8f8f8' height='50' align='center'><td>전화번호</td><td align='center' style=';font-size:15px;font-weight:bold;color:#000000;text-align-last:center;'><select name='viewadult' style='border:none; font-size:20px; line-height:30px; width:100%;font-weight:bold;text-align:center;background-color: #f8f8f8;'><option value='N' ".$strmemuserViewAdultN.">미노출</option><option value='Y' ".$strmemuserViewAdultY.">노출</option></select></td></tr>";
