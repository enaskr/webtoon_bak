...
<?php
	if ( $USER_LEVEL == 99999 ) {
		...
		while($row = $webtoonView->fetchArray(SQLITE3_ASSOC)){
			...
			echo "<img src='./shortcuts.png' style='padding:0;margin:0;max-height:30px;width:10%;' onClick='window.open(\"".urldecode($dbsite_url)."\");'></td>\n";
			echo "</tr>\n";
			...
			echo "<img src='./shortcuts.png' style='padding:0;margin:0;max-height:30px;width:10%;' onClick='window.open(\"".urldecode($dbnote)."\");'></td>\n";
			echo "</tr>\n";
