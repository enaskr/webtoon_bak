...
<?php
	if ( $USER_LEVEL == 99999 ) {
		$toonsiteList = "SELECT SITE_ID, SITE_NAME, SITE_TYPE, SERVER_PATH, MAIN_VIEW, UPDATE_YN, UPDATE_EXECUTE, UPTDTIME FROM SITE_INFO ORDER BY SITE_TYPE DESC, SITE_NAME ASC; ";
